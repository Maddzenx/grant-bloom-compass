      ...
      <div className="p-8 bg-[#f4f5f0]">
        ...
        <Tabs defaultValue="active" className="w-full">
          ...
          <TabsContent value="active" className="space-y-4">
            {savedGrants.activeApplications.length === 0 ? <Card className="p-8 bg-white border border-gray-200 shadow-sm text-center">
            ...
            return <Card key={grant.id} className="p-6 bg-white border border-gray-200 shadow-sm">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex gap-2">
                        <Button variant="default" className="bg-blue-600 hover:bg-blue-700 text-white px-6" onClick={() => handleEditClick(grant.id)}>
                          Redigera
                        </Button>
          ...
          <TabsContent value="pending" className="space-y-4">
            {savedGrants.pendingReview.length === 0 ? <Card className="p-8 bg-white border border-gray-200 shadow-sm text-center">
              ...
              </Card> : savedGrants.pendingReview.map(grant => <Card key={grant.id} className="p-6 bg-white border border-gray-200 shadow-sm">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">{grant.title}</h3>
          ...
          <TabsContent value="saved" className="space-y-4">
            {savedGrants.savedApplications.length === 0 ? <Card className="p-8 bg-white border border-gray-200 shadow-sm text-center">
              ...
              </Card> : savedGrants.savedApplications.map(grant => <Card key={grant.id} className="p-6 bg-white border border-gray-200 shadow-sm">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">{grant.title}</h3>
                    ...
                    <div className="flex gap-3">
                      <Button variant="outline" className="px-4" onClick={() => handleReadMore(grant)}>
                        Läs mer
                      </Button>
                      <Button variant="default" className="bg-blue-600 hover:bg-blue-700 text-white px-6" onClick={() => handleStartApplication(grant)}>
                        Börja ansöka
                      </Button>
                      <Button variant="outline" size="icon" className="border-gray-300">
                        <Download className="w-4 h-4" />
