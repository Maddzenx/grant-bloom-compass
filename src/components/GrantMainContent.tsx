...
const GrantMainContent = ({
  ...
  return <div className="space-y-8">
      ...
      <section>
        <h2 className="text-gray-900 mb-4 font-bold text-lg">About this grant</h2>
        <div className="text-gray-700 leading-relaxed space-y-4">
          <p className="text-sm">The Tech Innovation Grant 2024 is designed to support breakthrough technology startups developing solutions in artificial intelligence, blockchain, Internet of Things (IoT), and emerging technologies. This grant aims to accelerate innovation and help promising startups bridge the gap between research and market implementation.</p>
          <p className="text-sm">Our mission is to foster technological advancement that creates meaningful impact on society while supporting entrepreneurs who are building the future. Recipients will receive not only financial support but also access to our extensive network of mentors, industry experts, and potential investors.</p>
        </div>
      </section>
    </div>;
};
