    ...
    <>
      ...
      {state === "collapsed" && (
        <Button
          ...
          className="fixed top-4 left-4 z-50 flex items-center justify-center w-8 h-8 rounded-md hover:bg-gray-100 transition-colors bg-white shadow-md border border-gray-200"
