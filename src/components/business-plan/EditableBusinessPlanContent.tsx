  ...
  return <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div>
          ...
          <Textarea value={draft.sections.problemformulering || 'Value'} onChange={e => onUpdateField("utmaning", "utmaning_beskrivning", e.target.value)} className="bg-gray-50 border-gray-200 min-h-[100px]" placeholder="Beskriv utmaningen..." />
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div>
          ...
          <Textarea value={draft.sections.mal_och_resultat || 'Value'} onChange={e => onUpdateField("losning", "losning_beskrivning", e.target.value)} className="bg-gray-50 border-gray-200 min-h-[100px]" placeholder="Beskriv lösningen..." />
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div>
          ...
          <Textarea value="Value" onChange={e => onUpdateField("immaterial", "immaterial_beskrivning", e.target.value)} className="bg-gray-50 border-gray-200 min-h-[100px]" placeholder="Beskriv immaterialrätt..." />
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div>
          ...
          <Textarea value={draft.sections.malgrupp || 'Value'} onChange={e => onUpdateField("marknad", "marknad_beskrivning", e.target.value)} className="bg-gray-50 border-gray-200 min-h-[100px]" placeholder="Beskriv marknaden..." />
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-6">
        ...
        <div>
          ...
          <Textarea value="Value" onChange={e => onUpdateField("kommersialisering", "kommersiell_strategi", e.target.value)} className="bg-gray-50 border-gray-200 min-h-[100px]" placeholder="Beskriv kommersialisering..." />
        </div>
      </div>
    </div>;
};