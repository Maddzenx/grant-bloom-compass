      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1 sm:gap-2 md:gap-3 lg:gap-4">
            ...
            <span className="font-semibold mx-[3px] text-xs md:text-base sm:text-xs text-gray-900">
              {(() => {
                if (isDeadlinePassed) {
          ...
          <div className="flex items-center gap-1 sm:gap-2 md:gap-3 lg:gap-4">
            ...
            <span className="text-gray-900 font-semibold mx-[3px] text-xs md:text-base sm:text-xs">{grant.deadline}</span>
          </div>
        </div>
      </div>
    </div>
