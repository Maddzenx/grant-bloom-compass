...
const FAQSection = () => {
  ...
  return (
    <div className="relative z-10 w-full py-24 pb-20 px-6 bg-inherit">
      <div className="w-full max-w-6xl mx-auto">
        {/* Headline */}
        <div className="text-center mb-16">
          <h2 className="font-['Source_Sans_3'] font-normal text-gray-900 leading-[1.2]" style={{
        ...
        <div className="space-y-0">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-[#B8A8FF]">
              ...
              >
                <h3 className="font-['Source_Sans_3'] font-normal text-gray-900 pr-4 leading-[1.3]" style={{
              ...
              <div 
                ...
                className={`overflow-hidden transition-all duration-300 ease-out ${openItem === index ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`} 
                style={{ transitionProperty: 'max-height, opacity' }}
              >
                <div className="pt-5 pb-8">
                  <p className="font-['Source_Sans_3'] text-gray-800 leading-[1.55]" style={{
