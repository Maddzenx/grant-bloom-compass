...
const organizationTypes = [
  { key: 'foretag', label: 'Företag', mappedTypes: ['Företag', 'Ekonomiska föreningar', 'Enskilda näringsidkare'] },
  { key: 'forskning', label: 'Forskning', mappedTypes: ['Universitet och högskolor'] },
  { key: 'offentlig', label: 'Offentlig Sektor', mappedTypes: ['Offentlig sektor', 'Ideella föreningar'] }
];

const OrganizationTabs = ({ onSelectionChange }: OrganizationTabsProps) => {
  const { t } = useLanguage();
