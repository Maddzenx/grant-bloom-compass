  ...
  return (
    <div className="relative z-10 w-full py-32 pb-28 px-6 bg-[#F0F1F3]" id="cta-section" style={{ scrollMarginTop: '6rem' }}>
      <div className="w-full max-w-6xl mx-auto text-center">
        {/* Primary Headline */}
        <h2 
          className="font-newsreader font-normal text-gray-900 mb-12 leading-[1.15]"
        ...
        <div className="mb-16">
          <button
            className="bg-[#D1F364] hover:bg-[#C5E858] text-black font-newsreader font-medium px-12 py-4 rounded-full transition-all duration-200 hover:shadow-lg"
            style={{ 
              fontSize: '22px',
        ...
        <div className="mb-8">
          <p 
            className="font-newsreader font-normal leading-[1.4] mb-2"
            style={{ 
          ...
          <p 
            className="font-newsreader font-normal leading-[1.4]"
            style={{ 
              fontSize: 'clamp(18px, 4.5vw, 24px)',
              color: '#78797A'
            }}
        ...
        <div className="mt-8">
          <div 
            className="font-newsreader font-normal inline-block"
