              ...
              {isLoadingDetails ? (
                <div className="flex items-center justify-center h-64">
                  <div className="text-center">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 mx-auto mb-4" style={{ borderBottomColor: '#7D54F4' }}></div>
                    <p className="type-secondary text-zinc-600">Laddar bidragsinformation...</p>
                  </div>
                </div>
              ) : detailsError ? (
                <div className="flex items-center justify-center h-64">
                  <div className="text-center">
                    <p className="type-secondary text-red-600 mb-2">Ett fel uppstod vid laddning av bidragsinformation</p>
                    <Button 
                      variant="outline" 
                ...
                <div className="flex items-center justify-center h-64">
                  <p className="type-secondary text-zinc-600">Ingen bidragsinformation tillgänglig</p>
                </div>
              )}
            </div>
          </div>
