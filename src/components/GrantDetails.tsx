    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm text-gray-600">Bidrag</p>
      ...
      <div className="space-y-6">
        <section>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Om detta bidrag</h3>
          <p className="text-gray-700 leading-relaxed">{grant.aboutGrant}</p>
        </section>

        <section>
          <h3 className="text-lg font-medium text-gray-900 mb-3">Vem kan ansöka?</h3>
